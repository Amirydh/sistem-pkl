        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('peserta.kegiatan.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="judul_kegiatan" class="block mt-1 w-full" type="text" name="judul_kegiatan" :value="old('judul_kegiatan')" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="deskripsi" name="deskripsi" rows="5" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('deskripsi') }}</textarea>
