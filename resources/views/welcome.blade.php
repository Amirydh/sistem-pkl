...
<head>
    ...
    <link rel="icon" href="{{ asset('images/logo-pemerintahan.svg') }}" type="image/svg+xml">
    <!-- Fonts -->
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center flex-col items-center">
                ...
                <div class="text-center">
                    <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-800 dark:text-white leading-tight">
                        Sistem Manajemen PKL
                    </h1>
                    <p class="mt-4 text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                        Platform terintegrasi untuk mengelola jurnal kegiatan, validasi pembimbing, dan penilaian akhir Praktik Kerja Lapangan secara efisien.
                    </p>
                </div>

                <div class="mt-10 flex flex-col sm:flex-row items-center gap-4">
                    <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Daftar Sekarang
                    </a>
                    <a href="{{ route('login') }}" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Masuk
                    </a>
                </div>
            </div>
