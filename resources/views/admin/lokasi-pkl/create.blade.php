        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.lokasi-pkl.store') }}">
                        @csrf

                        <!-- Nama Tempat -->
                        <div>
                            <x-input-label for="nama_tempat" :value="__('Nama Tempat')" />
                            <x-text-input id="nama_tempat" class="block mt-1 w-full" type="text" name="nama_tempat" :value="old('nama_tempat')" required autofocus />
